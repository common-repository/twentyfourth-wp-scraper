...
<tr class="fs-site-details" data-blog-id="<?php echo $blog_id ?>" <?php if ($is_registered) : ?> data-install-id="<?php echo $install->id ?>" <?php endif ?>>
    ...
    <!-- More details button -->
    <td><?php if ($is_registered) : ?>
            <button class="fs-show-install-details button button-small">More details <i class="dashicons dashicons-arrow-right-alt2"></i>
            </button><?php endif ?></td>
    <!--/ More details button -->
</tr>
                    ...
                    <tr <?php if (1 == $row_index % 2) {
                        ...
                        <td>
                            ...
                            <?php if (!$is_whitelabeled) : ?>
                                <input type="text" value="<?php echo htmlspecialchars($install->secret_key) ?>" style="display: none" readonly /></td>
                    <?php endif ?>
                    <?php if (!$is_whitelabeled) : ?>
                    ...
                    <?php if (is_object($license)) : ?>
                        ...
                        <tr <?php if (1 == $row_index % 2) {
                            ...
                            <td>
                                ...
                                <?php if (!$is_whitelabeled) : ?>
                                    <input type="text" value="<?php echo htmlspecialchars($license->secret_key) ?>" style="display: none" readonly /></td>
                        <?php endif ?>
                        <?php if (!$is_whitelabeled) : ?>
                            <td>
